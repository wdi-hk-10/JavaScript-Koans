...
test("delimiters", function() {
    ...
    equal(yes, singleQuotedString === doubleQuotedString, 'are the two strings equal?');
});
...
test("character Type", function() {
    ...
    equal(m, characterType, 'Javascript has no character type');
});

test("escape character", function() {
    var stringWithAnEscapedCharacter  = "\u0041pple";
    equal(0, stringWithAnEscapedCharacter, 'what  is the value of stringWithAnEscapedCharacter?');
});
